...
namespace fc {
  ...
  struct tuple { 
    ...
    :a( fc_light::forward<AA>(aa) ),
     b( fc_light::forward<BB>(bb) ),
     c( fc_light::forward<CC>(cc) ),
     d( fc_light::forward<DD>(dd) )
     {}
   ...
   */
        ...
        template<typename T>
        struct is_tuple {
          typedef fc_light::false_type type;
        };

        #define RREF_PARAMS(z,n,data) BOOST_PP_CAT(AA,n)&& BOOST_PP_CAT(p,n)
        #define ILIST_PARAMS(z,n,data) BOOST_PP_CAT(a,n)( fc_light::forward<BOOST_PP_CAT(AA,n)>( BOOST_PP_CAT(p,n) ) )
        ...
        #define DEDUCE_MEMBERS(z,n,data) typename fc_light::deduce<BOOST_PP_CAT(AA,n)>::type
        #define FORWARD_PARAMS(z,n,data) fc_light::forward<BOOST_PP_CAT(AA,n)>(BOOST_PP_CAT(p,n))
        ...
        template<BOOST_PP_ENUM_PARAMS( n, typename AA)> \
        struct is_tuple<fc_light::tuple<BOOST_PP_ENUM_PARAMS(n,AA)> > { \
          typedef fc_light::true_type type; \
        }; \
        template<BOOST_PP_ENUM_PARAMS( n, typename AA)> \
        struct deduce<fc_light::tuple<BOOST_PP_ENUM_PARAMS(n,AA)> > { \
          typedef fc_light::tuple<BOOST_PP_ENUM( n, DEDUCE_MEMBERS,unused)>  type; \
        }; 
