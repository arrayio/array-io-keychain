	...
	: QDialog(parent)
{
	...
	expertValue->setStyleSheet("background-color:rgb(227,232,248);border-style:outset;border-width:0px;border-radius:7px;font:11pt \"Segoe UI\";color:rgb(70,134,255);padding:5px;");
	...
	OKButton->move(388, endControlPosition);
	CancelButton->move(291, endControlPosition);
...
int keychain_gui_win::_createFieldsForSwap(const Transaction &transaction, const int startPosition) //96
{
	...
	swap->SetValueStyle("font:12pt \"Segoe UI\";background:transparent;color:rgb(123,141,167);");
	...
	action->SetLabelStyle("font:12pt \"Segoe UI\";background:transparent;");
	action->SetValueStyle("font:12pt \"Segoe UI\";background:transparent;color:rgb(123,141,167)");
	...
	hash->SetLabelStyle("font:12pt \"Segoe UI\";background:transparent;");
	hash->SetValueStyle("font:12pt \"Segoe UI\";background:transparent;color:rgb(123,141,167)");
	...
	address->SetLabelStyle("font:12pt \"Segoe UI\";background:transparent;");
	address->SetValueStyle("font:12pt \"Segoe UI\";background:transparent;color:rgb(123,141,167)");
