...
#include <ethereum/core/TransientDirectory.h>
#include <ethereum/core/CommonIO.h>
...
TransientDirectory::~TransientDirectory()
{
	...
	if (!ec)
	{
	  wlog("Failed to delete directory, path = ${m_path}, ec = ${ec_msg}", ("m_path", m_path)("ec_msg", ec.message()));
	}
}
