...
namespace fc_light
{
   ...
   template<typename K, typename... T>
   void to_variant( const fc_light::flat_map<K,T...>& var,  variant& vo );
   ...
   template<typename T>
   void to_variant( const fc_light::flat_set<T>& var,  variant& vo );
   template<typename T>
   void from_variant( const variant& var, fc_light::flat_set<T>& vo );
   ...
   class variant
   {
      public:
       ...
       ~variant();
        ...
        {
           return *this = variant( fc_light::forward<T>(v) );
        }
...
FC_LIGHT_REFLECT_TYPENAME( fc_light::variant )
FC_LIGHT_REFLECT_ENUM( fc_light::variant::type_id, (null_type)(int64_type)(uint64_type)(double_type)(bool_type)(string_type)(array_type)(object_type)(blob_type) )
FC_LIGHT_REFLECT( fc_light::blob, (data) );
