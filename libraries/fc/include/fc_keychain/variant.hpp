...
#include <fc_keychain/container/deque_fwd.hpp>
#include <fc_keychain/container/flat_fwd.hpp>
...
FC_KEYCHAIN_REFLECT_TYPENAME( fc_keychain::variant )
FC_KEYCHAIN_REFLECT_ENUM( fc_keychain::variant::type_id, (null_type)(int64_type)(uint64_type)(double_type)(bool_type)(string_type)(array_type)(object_type)(blob_type) )
FC_KEYCHAIN_REFLECT( fc_keychain::blob, (data) );
