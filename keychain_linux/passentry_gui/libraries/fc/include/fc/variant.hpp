...
FC_REFLECT_TYPENAME( fc_light::variant )
FC_REFLECT_ENUM( fc_light::variant::type_id, (null_type)(int64_type)(uint64_type)(double_type)(bool_type)(string_type)(array_type)(object_type)(blob_type) )
FC_REFLECT( fc_light::blob, (data) );
