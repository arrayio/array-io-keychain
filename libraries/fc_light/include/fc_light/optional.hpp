...
# pragma warning(disable:4522) /* multiple assignment operators */
   ...
   *  fc_light::optional adds less than 400.
   */
  template<typename T>
  class optional
  {
    public:
      ...
      :_valid(false) 
      {
        if( o._valid ) new (ptr()) T( fc_light::move(*o) );
        _valid = o._valid;
        o.reset();
      }
      ...
      :_valid(true) 
      {
        new ((char*)ptr()) T( fc_light::forward<U>(u) );
      }
      ...
      {
        reset();
        new (ptr()) T( fc_light::forward<U>(u) );
        _valid = true;
        return *this;
      }
