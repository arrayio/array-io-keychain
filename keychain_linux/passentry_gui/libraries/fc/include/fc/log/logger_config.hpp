...
FC_REFLECT( fc_light::appender_config, (name)(type)(args)(enabled) )
FC_REFLECT( fc_light::logger_config, (name)(parent)(level)(enabled)(additivity)(appenders) )
FC_REFLECT( fc_light::logging_config, (includes)(appenders)(loggers) )
