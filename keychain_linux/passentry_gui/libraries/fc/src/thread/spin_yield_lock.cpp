...
/*
  bool spin_yield_lock::try_lock_for( const fc_light::microseconds& us ) {
    return try_lock_until( fc_light::time_point::now() + us );
  }

  bool spin_yield_lock::try_lock_until( const fc_light::time_point& abs_time ) {
