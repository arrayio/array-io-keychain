...
namespace  slave {
    enum struct cmds {unknown = 0, rawtrx, close, modify, length, check, focus, close_expert_mode, strength, last }; // to gui
...
FC_LIGHT_REFLECT_ENUM(slave::cmds, (unknown)(rawtrx)(close)(modify)(length)(check)(focus)(close_expert_mode)(strength)(last))
