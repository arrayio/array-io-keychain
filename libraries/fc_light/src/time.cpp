...
namespace fc_light {
  ...
  } FC_LIGHT_RETHROW_EXCEPTIONS( warn, "unable to convert ISO-formatted string to fc_light::time_point_sec" ) }
  ...
  } FC_LIGHT_RETHROW_EXCEPTIONS( warn, "unable to convert ISO-formatted string to fc_light::time_point" ) }
