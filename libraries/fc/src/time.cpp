...
namespace fc_keychain {
  ...
  } FC_KEYCHAIN_RETHROW_EXCEPTIONS( warn, "unable to convert ISO-formatted string to fc_keychain::time_point_sec" ) }
  ...
  } FC_KEYCHAIN_RETHROW_EXCEPTIONS( warn, "unable to convert ISO-formatted string to fc_keychain::time_point" ) }
