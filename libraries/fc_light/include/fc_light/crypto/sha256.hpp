...
#include <fc_light/platform_independence.hpp>
...
{
    template<>
    struct hash<fc_light::sha256>
    {
       size_t operator()( const fc_light::sha256& s )const
       {
           return  *((size_t*)&s);
       }
    };
...
FC_LIGHT_REFLECT_TYPENAME( fc_light::sha256 )
